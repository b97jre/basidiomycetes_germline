...
ggsave("../../results/DNA/coding/background.distributions.pdf",layout, width = 8.27, height = 11.7, units = "in")

ggsave("../../results/DNA/coding/background.distributions.png",dpi = 300,layout, width = 8.27, height = 11.7, units = "in")
